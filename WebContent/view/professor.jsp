                  ...
                  <table>
                     <tr>
                        ...
                        <td class="user_table"><input class="inaput" type="text"
                           name="id" value="<%=user.getId()%>" placeholder="아이디 4~10자리" pattern="[A-Za-z0-9]{4,10}"/><br/><%if(error!=null&&"아이디를 입력하세요".equals(error)) { %><span style="color:red;"><%=error %> <%} %></span>
                     ...
                     <tr>
                        ...
                        <td class="user_table"><input type="password"
                           ...
                           placeholder="비밀번호"  pattern="[A-Za-z0-9]{4,10}"/> <%if(error!=null&&"비밀번호을 입력하세요".equals(error)) { %><span style="color:red;"><%=error %>
                           <%} %></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td class="user_table"><input type="text"
                           ...
                           placeholder="전화번호 ex)010-xxxx-xxxx" pattern="[0-9]{3}{1}[0-9]{4}{1}[0-9]{4}"/> <%if(error!=null&&"연락처를 입력하세요".equals(error)) { %><span style="color:red;"><%=error %> <%} %></span></td>
                     </tr>
                     <tr>
                        <td class="user_table"><label id="user_label"
                     ...
                     <tr>
                        <td class="user_table"><label id="user_label" for="state" style="font-size:11px">직원/교수번호</label>
                        </td>
                        <td class="user_table">
                        <input type="password" name="state_id" value=<%=state %>><%if((error!=null&&"상태를 기입하세요".equals(error))||(error!=null&&"잘못기입하셨습니다.".equals(error))) { %><span style="color:red;"><%=error %> <%} %></span></td> 
                     </tr>
                     <tr>
                        <td class="user_table"><label id="user_label"
